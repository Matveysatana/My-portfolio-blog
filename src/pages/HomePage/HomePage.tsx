        ...
        <div className="conteiner ">
            <div className="home-page greeting-page">
                <div className="greeting">
                    ...
                    <p className="greeting-description">Привет! Меня зовут Матвей Сатановский, и я — начинающий веб-разработчик. Здесь вы найдёте мои проекты, статьи и мысли о программировании и разработке. Этот сайт — не просто портфолио, а место, где я делюсь своими идеями, учусь новому и вдохновляюсь.</p>
